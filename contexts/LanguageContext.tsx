...
const translations: Record<Language, Record<string, string>> = {
  es: {
	...
	'home.search.guest4': '4 Huéspedes',
	'home.search.guest5': '5 Huéspedes',
    ...
    'home.heritage.desc': '¡Bienvenidos a HOSTAL ELIZABETHA, tu hogar lejos de casa en el corazón del Eje Cafetero Colombiano! Imagínate despertar cada mañana en un ambiente acogedor y lleno de energía, en una zona rodeada de naturaleza, estamos ubicados en Carrera 4, a pocos pasos del centro del pueblo, lo que te permitirá sumergirte fácilmente en la cultura local, disfrutar de deliciosos cafés y descubrir tiendas de artesanías únicas. ¿Te apetece una aventura? ¡Las plantaciones de café y el impresionante Valle de Cocora están a tu alcance! tenemos un ambiente familiar y relajado, ideal para descansar después de un gran día de descubrimientos.',
    ...
    'home.cta.desc': 'En ELIZABETHA HOSTAL, ofrecemos más que solo un lugar para dormir. Queremos que vivas una experiencia inolvidable. Relájate en nuestros espacios comunes, conoce a otros viajeros de todo el mundo y comparte historias mientras disfrutas de la atmósfera amigable y confortable que nos caracteriza. ¡Prepárate para crear recuerdos inolvidables en este pequeño paraíso!',
    ...
    // Location
    'location.title': 'Encontrando Elizabetha Hostal',
    ...
    'location.tip.desc': 'Salento es un pueblo para caminar. Una vez llegues a la plaza principal, estamos a solo 5 cuadras caminando por la colorida Calle Real.',
	...
	'footer.links.privacy': 'Política de datos personales',
  ...
  en: {
	...
	'home.search.guest4': '4 Guests',
	'home.search.guest5': '5 Guests',
    ...
    'home.heritage.desc': 'Welcome to Hostal Elizabeth, your home away from home in the heart of Colombia Coffee Region! Imagine waking up every morning in a welcoming and vibrant atmosphere, surrounded by nature. We are located on Carrera 4, just steps from the town center, allowing you to easily immerse yourself in the local culture, enjoy delicious coffee, and discover unique artisan shops. Looking for an adventure? The coffee plantations and the stunning Cocora Valley are within easy reach! We offer a relaxed, family-friendly atmosphere, perfect for unwinding after a long day of exploring.',
    ...
    'home.cta.desc': 'At ELIZABETHA HOSTAL, we offer more than just a place to sleep. We want you to have an unforgettable experience. Relax in our common areas, meet other travelers from around the world, and share stories while enjoying our friendly and comfortable atmosphere. Get ready to create unforgettable memories in this little paradise!',
    ...
    // Location
    'location.title': 'Finding Elizabetha Hostal',
    ...
    'location.tip.desc': 'Salento is a walking town. Once you arrive at the main plaza, we are just a short 5-block walk up the colorful Calle Real.',
	...
	'footer.links.privacy': 'Personal Policy',
