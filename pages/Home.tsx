          ...
          <div className="max-w-6xl mx-auto bg-white dark:bg-zinc-900 shadow-2xl rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-end md:items-center gap-6 border border-slate-100 dark:border-zinc-800">
            <div className="flex-1 w-full">
              ...
              <div className="relative">
                ...
                <input className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-zinc-800 border-none rounded-xl focus:ring-2 focus:ring-primary" type="date" />
              </div>
            </div>
            <div className="flex-1 w-full">
            ...
            <div className="flex-1 w-full">
              ...
              <div className="relative">
                ...
                <select className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-zinc-800 border-none rounded-xl focus:ring-2 focus:ring-primary appearance-none">
            ...
            <button className="w-full md:w-auto bg-secondary text-white px-10 py-4 rounded-xl font-bold hover:bg-opacity-90 transition-all flex items-center justify-center gap-2">
              Check Availability
